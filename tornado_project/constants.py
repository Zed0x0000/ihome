...
QINIU_URL_PREFIX = "http://ov4auik4d.bkt.clouddn.com/"  # 七牛存储空间的域名

REDIS_AREA_INFO_EXPIRES_SECONDS = 86400  # redis缓存城区信息的有效期
REDIS_HOUSE_INFO_EXPIRES_SECONDS = 86400  # redis缓存房屋信息的有效期
