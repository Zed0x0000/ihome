...
function sendSMSCode() {
    ...
    //         }
    // }, 'json');
    var data = {mobile:mobile, pic_code:imageCode, pic_code_id:imageCodeId};
    $.ajax({
        url: "/api/smscode",
        method: "POST",
        headers: {
        ...
        success: function (data) {
            ...
            // }
            if ("0" == data.err_no) {
                $("#image-code-err span").html(data.err_msg);
                $("#image-code-err").show();
                var duration = 60;
                ...
                $("#image-code-err").show();
                $(".phonecode-a").attr("onclick", "sendSMSCode();")
                if (data.err_no == "4001" || data.err_no == "4002" || data.err_no == "4004") {
                    generateImageCode();
                }
            }
        }
